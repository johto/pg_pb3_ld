...
int32
pb3_varint_key_size(int32 field_number)
{
	return pb3_varint_size((field_number << 3) | 0);
}

int32
pb3_varlen_key_size(int32 field_number)
{
	return pb3_varint_size((field_number << 3) | 2);
}
...
pb3_fix_reserved_length(StringInfo s, int reserved_start, int reserved_len)
{
	...
	int32 msg_len = (int32) s->len - reserved_start - reserved_len;
